            ...
            <div class="row mb-8">
                <div class="col-md-12">
                    ...
                    <div class="card bg-light border-0 rounded-4"
                        :style="{ backgroundImage: 'url(/images/banner/slider-2.jpg)' }"
                        ...
                        <div class="card-body p-lg-12">
                            ...
                            <a href="#" class="btn main-theme">Create Product</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="mb-2">
                                        ...
                                        <span class="ms-1">
                                            <span class="text-dark">Shippings $32.98</span> (2%)
                                        </span>
                                    </li>
                                    <li class="mb-2">
                                        <i class="bi bi-circle-fill text-warning"></i>
                                        <span class="ms-1">
                                            <span class="text-dark">Refunds $11</span> (11%)
                                        </span>
                                    </li>
                                    <li class="mb-2">
                                        <i class="bi bi-circle-fill text-danger"></i>
                                        <span class="ms-1">
                                            <span class="text-dark">Order $14.87</span> (1%)
                                        </span>
                                    </li>
                                    <li>
                                        <i class="bi bi-circle-fill text-info"></i>
                                        <span class="ms-1">
                                            <span class="text-dark">Income 3,271</span> (86%)
                                        </span>
                                    </li>
